# GenerateQualityReport.ps1 - Master Quality Report Generator
# Runs all quality checks and generates comprehensive report

param(
    [string]$SourcePath = "Source",
    [string]$OutputDir = "Docs/Quality"
)

$ErrorActionPreference = "Continue"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  HorrorProject Quality Analysis Suite" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[1/4] Running Code Style Check..." -ForegroundColor Yellow
& "$PSScriptRoot/CodeStyleCheck.ps1" -SourcePath $SourcePath -OutputFile "$OutputDir/CodeStyleReport.md"

Write-Host ""
Write-Host "[2/4] Running Static Analysis..." -ForegroundColor Yellow
& "$PSScriptRoot/StaticAnalysis.ps1" -SourcePath $SourcePath -OutputFile "$OutputDir/StaticAnalysisReport.md"

Write-Host ""
Write-Host "[3/4] Running Complexity Analysis..." -ForegroundColor Yellow
& "$PSScriptRoot/ComplexityAnalysis.ps1" -SourcePath $SourcePath -OutputFile "$OutputDir/ComplexityReport.md"

Write-Host ""
Write-Host "[4/4] Running Dependency Analysis..." -ForegroundColor Yellow
& "$PSScriptRoot/DependencyAnalysis.ps1" -SourcePath $SourcePath -OutputFile "$OutputDir/DependencyReport.md"
...
Write-Host ""
Write-Host "Generating master quality report..." -ForegroundColor Cyan
...
$masterReport | Out-File "$OutputDir/MasterQualityReport.md" -Encoding UTF8
...
Write-Host "- MasterQualityReport.md" -ForegroundColor White
Write-Host "- CodeStyleReport.md" -ForegroundColor White
Write-Host "- StaticAnalysisReport.md" -ForegroundColor White
Write-Host "- ComplexityReport.md" -ForegroundColor White
Write-Host "- DependencyReport.md" -ForegroundColor White
Write-Host ""
