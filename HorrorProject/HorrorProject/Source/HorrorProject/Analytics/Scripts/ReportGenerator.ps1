...
if ([string]::IsNullOrWhiteSpace($AnalysisPath)) { $AnalysisPath = Join-Path $ProjectRoot "Saved\Analytics\Analysis" }
if ([string]::IsNullOrWhiteSpace($OutputPath)) { $OutputPath = Join-Path $ProjectRoot "Saved\Analytics\Reports" }
